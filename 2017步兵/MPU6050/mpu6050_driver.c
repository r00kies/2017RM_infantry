...
int MPU6050_ReadData(void)
{
    ...
    else
    {
        ...
        MPU6050_Real_Data.Gyro_X = (float)(MPU6050_Raw_Data.Gyro_X - GYRO_OFFSET.x)/65.5;     //见datasheet 32 of 47
        MPU6050_Real_Data.Gyro_Y = (float)(MPU6050_Raw_Data.Gyro_Y - GYRO_OFFSET.y)/65.5;     //见datasheet 32 of 47
        MPU6050_Real_Data.Gyro_Z = (float)(MPU6050_Raw_Data.Gyro_Z - GYRO_OFFSET.z)/65.5;     //见datasheet 32 of 47
    } 
    return 0;
}
void MPU6050_Gyro_update(void)
{
	...
	for(i=0; i<100; i++)
	{
		...
		y_temp=y_temp+MPU6050_Real_Data.Gyro_Y;
	}

	x_temp=x_temp/10.00;
	y_temp=y_temp/10.00;	

	MPU6050_Real_Data.Gyro_Y=y_temp;
...
void MPU6050_Gyro_calibration(void)
{
	...
	GYRO_OFFSET.x=x_temp;
	GYRO_OFFSET.y=y_temp;
	GYRO_OFFSET.z=z_temp;
